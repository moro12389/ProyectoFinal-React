                ...
                <div className=''>
                    ...
                    <div className="absolute
                        ...
                        <div className="absolute w-2 h-2 -bottom-8 -left-8 rounded-full">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20" stroke="currentColor" className="w-6 h-6 mx-auto text-white">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M19 9l-9 9-9-9"></path>
                            </svg>
                        </div>
                    </div>
