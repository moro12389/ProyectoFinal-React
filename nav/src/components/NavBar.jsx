...
const [isNavbarVisible, setIsNavbarVisible] = useState(true);
  ...
  return (
    <>
      <header className="">
        <div className='hidden pl-4 sm:flex xs:pl-1'>
	   ...
	   fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-dark/90 rounded-lg backdrop backdrop-blur-md py-32'>
        ...
        <div className='flex flex-row items-center justify-around sm:justify-around'>
          <div className=''>
            <img src={Logo} alt="" className="sm:w-24 sm:ml-12 xs:w-16 xs:ml-9" />
          </div>
          <ul className='flex flex-row '>
            ...
            <li className='mx-16 py-2 text-sm font-semibold sm:mx-0 sm:mr-4 sm:whitespace-nowrap xl:block  sm:hidden'>About Us</li>
            <li className='py-2 text-sm font-semibold xl:block sm:hidden'>Contacts</li>
          </ul>
