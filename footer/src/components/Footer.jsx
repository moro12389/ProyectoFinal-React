...
import footerLogo from '../../public/img/logofooter.png'
import creditCards from '../../public/img/creditcards.png'
...
const Footer = () => {
  ...
  return (
    <>
      <footer className='w-full h-64 bg-footerBg flex flex-col xxl:bg-posright xl:bg-footerBgXl sm:bg-center'>

        <div className='flex flex-row items-center justify-between h-full mx-6 sm:mx-4'>
          <div className='sm:mt-4'>
            {footerMenu.map((data, index) => (
              <ul key={index}>
                <li className='text-white mb-3 xs:mb-2'>{data}</li>
              </ul>
            ))}
          </div>
          <div>
        ...
        <div className='flex flex-row justify-between items-center mx-6 mb-2 sm:flex-col xs:relative xs:bottom-2'>
          ...
          <div className='flex flex-row items-center'>
            ...
            <p className='text-white my-1'>2023 Mr.Chef</p>
          </div>
          <div className='flex flex-row items-center'>
